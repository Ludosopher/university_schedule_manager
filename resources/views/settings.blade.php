    ...
    <div class="container">
        ...
        <div class="external-form-container">
            <div class="internal-form-container" style="width: 30%;">
                <h2 style="margin-top: 1.5rem">Обновление настроек приложения</h2>
                ...
                @csrf
                                    ...
                                    @if($setting->name === $form['name'])
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <div class="form-check form-switch">
                                                            ...
                                                            @endif
                                                            <label class="form-check-label" for="{{ $field_name }}">{{ $form['header'] }}</label>
                                                        </div>
                                        ...
                                        @if($form['type'] == 'input')
                                            ...
                                            <tr style="height: 50px;">
                                                {{-- <div class="mb-3"> --}}
                                                    <td>
                                                        <label for="{{ $field_name }}" class="form-label" style="margin: 0px; line-height: 100%;">{{ $form['header'] }}
                    ...
                    <button type="submit" class="btn btn-primary" style="float: right;">Обновить</button>
                </form>
            </div>
        </div>
