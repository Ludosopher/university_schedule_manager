...
@section('content')
    <div class="main-nav">
        ...
        <h1 class="hp-main-header">Менеджер учебного расписания</h1>
    </div>
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <h2 class="hp-header">Экспорт в Word (формат docx)</h2>
                <p class="hp-text"><span class="hp-capital-letter">Д</span>ля того, чтобы распечатать и иметь при себе полученные результаты, предусмотрен их экспорт в Word (формат docx). Для 
                этого необходимо нажать на кнопку "В Word" над любым из расписаний. Также экспортировать в Word можно список вариантов 
                самены занятия.</p>
            </li>
        </ul>
    </div>
