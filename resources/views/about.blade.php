    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>
                ...
                <p class="hp-text"><span class="hp-capital-letter">Д</span>ля того, чтобы внести свои поправки, распечатать и иметь при себе полученные результаты, предусмотрен их экспорт в Word (формат docx). Для
