            ...
            <div class="getAllLeft">
                ...
                @csrf
                    @if(isset($data['filter_form_fields']))
                        ...
                        @endforeach    
                    @endif
                    <p class="form-explanation" style="margin-top: 10px;"><span style="color: red;">*</span> Для выбора нескольких полей нажмите и удерживайте клавишу 'Ctrl'. Также и для отмены выбора.</p>
