    ...
    <div class="container">
        ...
        <div class="getAllContainer">
            <div class="getAllLeft">
                <h4>Найти</h4>
                <form method="POST" action="{{ route('groups-filter') }}">
                @csrf
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-top: 20px;">Показать</button>
                </form>
            </div>
            <div class="getAllRight">
                ...
                <nav aria-label="Page navigation example" class="nav-pagination">
                    <ul class="pagination">
                        <li class="page-item">
                            <form id="page-to-left" method="post" action="{{ route('groups-filter') }}">
                            @csrf
                        ...
                        @for($i = 1; $i <= $data['pages_number']; $i++)
                            @if($data['current_page'] == $i)
                                <li class="page-item">
                                    <form id="page-number{{ $i }}" method="post" action="{{ route('groups-filter') }}">
                                    @csrf
                        ...
                        @endfor
                        <li class="page-item">
                            <form id="page-to-right" method="post" action="{{ route('groups-filter') }}">
                            @csrf
