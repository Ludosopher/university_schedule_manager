...
@section('content')
    ...
    <div class="replacement-schedule-header-div">
        ...
        <div class="schedule-button-group">
            <form class="schedule-form" method="POST" action="{{ route('group-schedule', ['schedule_group_id' => $data['schedule_instance_id']]) }}" target="_blank">
            @csrf
            ...
            <form class="schedule-form" method="POST" class="month-schedule-form" action="{{ route('group-month-schedule', ['schedule_group_id' => $data['schedule_instance_id']]) }}" target="_blank">
            @csrf
