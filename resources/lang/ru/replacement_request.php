<?php
    ...
    return [
        'name' => 'Замена преподавателей в группе group: [replaceable_teacher - replaceable_class_period пара, replaceable_week_day replaceable_date] <-> [replacing_teacher - replacing_class_period пара, replacing_week_day replacing_date]',
        'replacement_request_added' => '? добавлена.',
