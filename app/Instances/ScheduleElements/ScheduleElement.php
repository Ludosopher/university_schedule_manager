...
class ScheduleElement extends Instance
{
    ...
    // Log::channel('mail')->info('if 1 elseif');
    ...
    //         }
    //     } else {
    // Log::channel('mail')->info('if 1 else');
    ...
    //     } else {
    // Log::channel('mail')->info('else 2');
    //         if (isset($data['rescheduling_lesson_id'])) {
    // Log::channel('mail')->info('else 2 if');
    //             if ($data['is_reschedule_for'] == 'teacher') {
    // Log::channel('mail')->info('else 2 if if');
    ...
    //         } else {
    // Log::channel('mail')->info('else 2 else');
    //             if (isset($data['teacher_name'])) {
    // Log::channel('mail')->info('else 2 else if');
    //                 $participant_header = __('header.teacher');
    //                 $participant = $data['teacher_name'];
    //             } elseif (isset($data['group_name'])) {
    // Log::channel('mail')->info('else 2 else elseif');
    //                 $participant_header = __('header.group');
    //                 $participant = $data['group_name'];
    //             } else {
    // Log::channel('mail')->info('else 2 else else');
    //                 $participant_header = '';
    //                 $participant = '';
    //             }
    ...
    //         }
    //     } else {
    // Log::channel('mail')->info('else 3');
    //         foreach($week_days as $week_day_id => $week_day_name) {
    //             if ($week_day_id <= $week_days_limit) {
    // Log::channel('mail')->info('else 3 if');
    ...
    // Log::channel('mail')->info('if 4 if if if');
    ...
    // Log::channel('mail')->info('if 4 if elseif');
    ...
    //                         if (!$lesson_red) {
    // Log::channel('mail')->info('if 4 if elseif if');
    ...
    //                         } elseif (!$lesson_blue) {
    // Log::channel('mail')->info('if 4 if elseif elseif');
    ...
    //                         } else {
    // Log::channel('mail')->info('if 4 if elseif else');
    //                             $redFontStyle = array('size' => 6);
    //                             $blueFontStyle = array('size' => 6);
    //                             $red_name = __('content.'.$lesson_red['name']);
    //                             $red_type = '('.__('dictionary.'.$lesson_red['type']).')';
    ...
    // Log::channel('mail')->info('if 4 if elseif if 2');
    ...
    // Log::channel('mail')->info('if 4 if elseif elseif 2');
    ...
    // Log::channel('mail')->info('if 4 if elseif if 3');
    ...
    // Log::channel('mail')->info('if 4 if elseif elseif 3');
    //                             $blueFontStyle = array_merge($blueFontStyle, ['bold' => true]);
    //                             $blue_replacement_massage = true;
    //                         }
    //             print_r(!is_array($lesson_red) ? '*no array <br>' : '*is array' .'<br>');
    //             print_r($lesson_red ? '*is lesson_red <br>' : '*is no lesson_red' .'<br>');
    //                         if (!is_array($lesson_red) && $lesson_red) {
    //             print_r('+++<br>');
    // Log::channel('mail')->info('if 4 if elseif if 4');
    ...
    // Log::channel('mail')->info('if 4 if elseif elseif 4');
    //                             $redFontStyle = array_merge($redFontStyle, ['bold' => true]);
    //                             $red_reschedule_massage = true;
    //                         }
    //                         if (!is_array($lesson_blue) && $lesson_blue) {
    // Log::channel('mail')->info('if 4 if elseif if 5');
    ...
    // Log::channel('mail')->info('if 4 if elseif elseif 5');
    //                             $blueFontStyle = array_merge($blueFontStyle, ['bold' => true]);
    ...
    //                     } else {
    // Log::channel('mail')->info('if 4 if else');
