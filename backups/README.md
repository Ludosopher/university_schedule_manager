...
The app contains fictional data about teachers, student groups, and study sessions. In full (to demonstrate all the functionality), the data is available only for the Faculty of Business and Social Technologies.
...
Приложение содержит вымышленные данные преподавателей, студенческих групп и учебных занятий. В полном объёме (для демонстрации  всего функционала) данные присутствуют только для факультета бизнеса и социальных технологий.
