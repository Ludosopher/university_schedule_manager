   ...
   'lesson_replacement_filter' => [
      ...
      'settings' => [
         ...
         [
            ...
            'header' => 'Число дней недели в регулярном расписании',
            'max' => 6,
            'min' => 5,
            'is_required' => true,
         ],
         [
            ...
            'header' => 'Число дней недели в датированном расписании',
            'max' => 6,
            'min' => 5,
            'is_required' => true,
         ],
         [
            ...
            'header' => 'Максимальное число пар в день в регулярном расписании',
            'max' => 5,
            'min' => 4,
            'is_required' => true,
         ],
         [
            ...
            'header' => 'Максимальное число пар в день в датированном расписании',
            'max' => 5,
            'min' => 4,
            'is_required' => true,
         ],
